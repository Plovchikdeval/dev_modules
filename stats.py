...
<emoji document_id=5870948572526022116>✋</emoji><emoji document_id=6035084557378654059>👤</emoji><b> Blocked users: </b><code>{blocked_users}</code>
<emoji document_id=5870948572526022116>✋</emoji><emoji document_id=6030400221232501136>🤖</emoji><b> Blocked bots: </b><code>{blocked_bots}</code>""",
...
<emoji document_id=5870948572526022116>✋</emoji><emoji document_id=6035084557378654059>👤</emoji><b> Заблокированные пользователи: </b><code>{blocked_users}</code>
<emoji document_id=5870948572526022116>✋</emoji><emoji document_id=6030400221232501136>🤖</emoji><b> Заблокированные боты: </b><code>{blocked_bots}</code>""",
